// Toon (cel-shaded) duplicate of: Hair/Procedural Bonus/13 super shine.fx
// customA = shadow terminator threshold, customB = shadow color. Look grading: ray.conf TOON_*
#define ALBEDO_MAP_FROM 3
#define ALBEDO_MAP_UV_FLIP 0
#define ALBEDO_MAP_APPLY_SCALE 0
#define ALBEDO_MAP_APPLY_DIFFUSE 1
#define ALBEDO_MAP_APPLY_MORPH_COLOR 0
#define ALBEDO_MAP_FILE "hair.jpg"
...
#define NORMAL_MAP_FILE "hair.jpg"

const float normalMapScale = 2.0;
const float normalMapLoopNum = 4.0;
...
#define SMOOTHNESS_MAP_FILE "hair.jpg"
...
#define METALNESS_MAP_FILE "v.jpg"
...
#define SPECULAR_MAP_FILE "v.jpg"
...
#define CUSTOM_A_MAP_FILE "v.jpg"
