// Tone-based toon material (smooth hardness ramp).
// Ramp hardness  : customA (0 = soft, 1 = hard cel)
// Shadow tint    : customB
// Look grading knobs          : ray.conf -> TOON_SHADOW_*, TOON_AUTOTINT_*, ...
...
// SHADINGMODELID_CEL: hard 2-band ramp
#define CUSTOM_ENABLE 9
...
const float3 customB = float3(0.70, 0.60, 0.75);
